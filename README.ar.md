...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 099 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.
...
- تحويل شخص أو حيوان أو غرض أو مكان واضح الهوية إلى تميمة جاهزة للحملة؛
- الحفاظ على الهوية في المقاس الصغير عبر 3–5 سمات وهندسة مستديرة ومحيط عريض ونسب مبالغ فيها؛
- بناء صورة حملة بحروف ضخمة ونظام من 2–4 ألوان مشتقة من الأصل؛
...
```text
تحديد الموضوع وجوهر السرد → استخراج 3–5 سمات هوية ثابتة → تحويلها إلى شخصية بهندسة مستديرة وShape Language → تنظيم الحروف الضخمة حول الشخصية بوصفها المركز المطلق → اشتقاق نظام علامة من 2–4 ألوان من الصورة → استخدام الفقاعات أو العلامات القليلة لخدمة التكوين فقط
```

## سمات النتيجة النهائية

- ابنِ الشخصية بمحيط أسود عريض ونظيف ذي مرونة رسم رقمي خفيفة، وبمساحات كبيرة من اللون الصافي.
- اجعل الشخصية المركز المطلق؛ ويمكن للحروف الضخمة أن تُحجب أو تتداخل أو تُقص لتصبح بنية الصفحة.
- استخرج من الصورة 2–4 ألوان واضحة الهوية وحوّلها إلى نظام علامة، ولا تنسخ كل ألوان الأصل.
- لا تستخدم فقاعة كلام إلا عندما تضيف قيمة للشخصية أو السرد، واجعل النص المساند صغيراً ومنضبطاً.
- تجنّب الإضاءة الواقعية والحجوم المعقدة والأنمي و3D والتدرجات البلاستيكية والملصقات العامة وقوالب الشبكات الاجتماعية.
...
يحافظ كل مشروع من مشاريع Panel الـ99 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 099 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–099) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
