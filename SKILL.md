...
```text
/xxd-panel-099 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，099 设计在下）
2. 左右对照（原图在左，099 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-099/<fresh-task>/
...
- `references/xxd-panel-099-prompt.zh-CN.md`
- `references/xxd-panel-099-prompt.en.md`
